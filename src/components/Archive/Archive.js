...
export default function Main() {
    ...
    const fetchProducts = async () => {
        const response = await fetch(`${URL}/legacy_products?limit=${showItemCount}&page=${page}&s=${searchString}&shop=${shopString}`, parameters);
    ...
    return (
        <div className="content" style={{ backgroundColor: "#f1f1f1" }}>
            ...
            {modalShow ? <ItemModal legacy={true} show={modalShow} item={modalItem} close={closeModal}></ItemModal> : null}
